                ...
                for level_1_line in level_1_lines:
                    ...
                    for level_2_line in level_2_lines:
                        ...
                        lines.append({
                            ...
                            'columns': [{'name': period_dict.get(period) if period in period_dict.keys() else 0} for
                                        period in periods],
                            'level': 3,
                    ...
                    lines.append({
                        ...
                        'name': 'Total',
                        'columns': [{'name': main_balance_dict.get(period) if period in main_balance_dict.keys() else 0}
