...
class CONAC_4_1(models.AbstractModel):
    _name = "jt_conac.4.1"
    ...
    def _get_templates(self):
        templates = super(CONAC_4_1, self)._get_templates()
    ...
    def _get_accounts_not_found(self, afr_lines):
        ...
        if accounts:
            lines.append({
                'id': 'misconfigured_accounts_4_1',
                'type': 'line',
                'name': _('Activo Accounts'),
                'footnotes': {},
                'columns': [{'name': ''}],
                'level': 1,
                'unfoldable': False,
    ...
    # get CONAC account dict for specific account
