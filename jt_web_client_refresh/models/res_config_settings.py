...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        param.set_param("jt_web_client_refresh.refresh_delay", self.refresh_delay)
        return res
    ...
    def get_values(self):
        ...
        res.update(refresh_delay=int(params.get_param("jt_web_client_refresh.refresh_delay", default=1000)))
        return res
